pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://51.20.187.224:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://16.171.60.131:9090/springapp1"
            echo "✅ Frontend deployed: http://16.171.60.131:9090/frontapp1"
        }
        failure {

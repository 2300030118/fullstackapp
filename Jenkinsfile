pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://16.171.239.194:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/2300030118/fullstackapp.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://16.171.239.194:9090/springapp1"
            echo "✅ Frontend deployed: http://16.171.239.194:9090/frontapp1"
        }
        failure {
